...
import aquality.appium.elements.interfaces.IComboBox;
...
public class ComboBox extends Element implements IComboBox {
    ...
    private final String LOG_SELECTING_VALUE = getLocManager().getValue("loc.selecting.value");

    protected ComboBox(final By locator, final String name) {
        super(locator, name);
    }
