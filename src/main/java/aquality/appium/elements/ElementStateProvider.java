...
class ElementStateProvider implements IElementStateProvider {
    ...
    public boolean waitForClickable(long timeout) {
        ...
        DesiredState desiredState = new DesiredState(element -> element.isDisplayed() && element.isEnabled(),
                getDesiredStateMessage(stateName, timeout)).withCatchingTimeoutException();
    ...
    public boolean waitForDisplayed(long timeout) {
        getLogger().info(String.format(getLocManager().getValue("loc.waitinstate"), "DISPLAYED", getLocator()));
        DesiredState desiredState = new DesiredState(WebElement::isDisplayed,
                getDesiredStateMessage("DISPLAYED", timeout)).withCatchingTimeoutException();
        return isElementInDesiredCondition(timeout, desiredState);
    }
    ...
    public boolean waitForNotDisplayed(long timeout) {
        ...
        DesiredState desiredState = new DesiredState(element -> !element.isDisplayed(),
                getDesiredStateMessage("NOT DISPLAYED", timeout)).withCatchingTimeoutException();
        return isElementInDesiredCondition(timeout, desiredState);
    }
    ...
    public boolean waitForExist(long timeout) {
        ...
        DesiredState desiredState = new DesiredState(Objects::nonNull,
                getDesiredStateMessage("EXIST", timeout)).withCatchingTimeoutException();
        return isElementInDesiredCondition(timeout, desiredState);
    }
    ...
    public boolean waitForEnabled(long timeout) {
        DesiredState desiredState = new DesiredState(y ->
                ...
                .withCatchingTimeoutException().withThrowingNoSuchElementException();
        return isElementInDesiredCondition(timeout, desiredState);
    }
    ...
    public boolean waitForNotEnabled(long timeout) {
        DesiredState desiredState = new DesiredState(driver -> !isEnabled(),
                getDesiredStateMessage("NOT ENABLED", timeout))
                .withCatchingTimeoutException().withThrowingNoSuchElementException();
        return isElementInDesiredCondition(timeout, desiredState);
    }
    ...
    private List<WebElement> findElements(long timeout) {
        return ElementFinder.getInstance().findElements(getLocator(), timeout);
    }
