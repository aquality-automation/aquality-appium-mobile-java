package aquality.appium.utils;

import aquality.appium.configuration.IRetryConfiguration;
...
public class ElementActionRetrier {
    ...
    {
        IRetryConfiguration retryConfiguration = null;// todo: implement Configuration.getInstance().getRetryConfiguration();
    ...
    private static boolean isExceptionHandled(Exception exception)
    {
        return (exception instanceof StaleElementReferenceException) ||
                (exception instanceof InvalidElementStateException);
    }
}